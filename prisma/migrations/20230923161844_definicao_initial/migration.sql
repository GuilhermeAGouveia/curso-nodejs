...
-- AddForeignKey
ALTER TABLE `Telefone` ADD CONSTRAINT `Telefone_id_professor_fkey` FOREIGN KEY (`id_professor`) REFERENCES `Professor`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Telefone` ADD CONSTRAINT `Telefone_id_aluno_fkey` FOREIGN KEY (`id_aluno`) REFERENCES `Aluno`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
